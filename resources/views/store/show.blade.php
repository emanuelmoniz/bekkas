<x-app-layout>
    ...
    <div class="py-4">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-4 flex">
            <a href="{{ $backUrl }}" class="text-sm text-accent-primary flex items-center gap-1 hover:text-accent-primary/90 no-underline">
            ...
            <div class="bg-white p-6 rounded shadow space-y-4 anim-item" x-data="productPage(
                ...
                @if ($product->stock > 0 || $product->is_backorder)
                    <form method="POST"
                        ...
                        <x-primary-cta x-bind:disabled="adding"
