...
$classes = ($active ?? false)
            ? 'inline-flex items-center h-full px-1 pt-1 border-b-2 border-primary text-sm font-sans font-medium leading-5 text-dark focus:outline-none focus:border-primary transition duration-150 ease-in-out'
