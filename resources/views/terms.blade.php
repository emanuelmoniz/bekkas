...
<x-app-layout>
        ...
        <section class="py-16 lg:py-24">
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <h2 id="shipping" class="mt-8 text-2xl font-semibold">{{ t('legal.shipping.title') ?: 'Shipping Policy' }}</h2>
                <div class="prose mt-4">{!! nl2br(e(t('legal.shipping_policy') ?: 'Shipping policy text.')) !!}</div>

                <h2 id="returns" class="mt-8 text-2xl font-semibold">{{ t('legal.returns.title') ?: 'Return and Refunds Policy' }}</h2>
