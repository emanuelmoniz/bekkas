...
<x-app-layout>
        ...
        <section class="py-16 lg:py-24">
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <p class="prose">{!! nl2br(e(t('legal.privacy_policy', ['company' => config('app.name')]) ?: t('legal.privacy.content'))) !!}</p>

                <h2 id="cookies" class="mt-8 text-2xl font-semibold">{{ t('legal.cookies.title') ?: 'Cookies Policy' }}</h2>
                <div class="prose mt-4">{!! nl2br(e(t('legal.cookies_policy', ['company' => config('app.name')]) ?: 'Cookies policy text.')) !!}</div>
