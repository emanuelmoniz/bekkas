                            ...
                            <td class="px-3 py-2 text-right">
                                @if($s->order)
                                    <div class="flex gap-2 justify-end items-center">
                                        <a href="{{ route('admin.orders.checkouts.show', $s) }}" class="text-sm bg-accent-primary/10 border-accent-primary/20 text-accent-primary border px-3 py-1 rounded">View</a>
                                    </div>
                                @else
