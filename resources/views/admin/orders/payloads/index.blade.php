    ...
    <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-4">
            <nav class="flex gap-2 text-sm" aria-label="Admin orders subnav">
                ...
                <a href="{{ route('admin.orders.payloads.index') }}" class="px-3 py-2 rounded bg-white border border-gray-200 shadow-sm">Payloads</a>
            </nav>
        </div>
                    ...
                    @foreach ($payloads as $p)
                        <tr class="border-t">
                            ...
                            <td class="px-3 py-2 text-right">
                                @if($p->order)
                                    <a href="{{ route('admin.orders.payloads.show', $p) }}" class="text-blue-600 hover:underline">View</a>
                                @else
