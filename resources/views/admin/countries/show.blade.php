    ...
    <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow rounded p-6 mb-6">
            ...
            <dl class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <p class="text-xs text-grey-dark font-medium uppercase tracking-widest">ISO Alpha-2</p>
                    <p class="text-sm text-grey-dark mt-1 font-mono">{{ $country->iso_alpha2 }}</p>
                </div>
                <div>
                    <p class="text-xs text-grey-dark font-medium uppercase tracking-widest">Country Code</p>
