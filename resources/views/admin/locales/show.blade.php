    ...
    <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow rounded p-6 mb-6">
            ...
            <dl class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                    <p class="text-xs text-grey-dark uppercase tracking-widest">Code</p>
                ...
                <div>
                    <p class="text-xs text-grey-dark uppercase tracking-widest">Flag</p>
                ...
                <div>
                    <p class="text-xs text-grey-dark uppercase tracking-widest">Default</p>
                    <p class="text-sm text-grey-dark mt-1">
