<x-app-layout>
    ...
    <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="mb-4 flex justify-end">
            <button type="button" onclick="window.location.href='{{ route('admin.ticket-categories.create') }}'"
        class="bg-primary text-white px-2 py-2 rounded uppercase text-sm">
                New Category
            </button>
        </div>
        ...
        <form method="GET" class="mb-6 bg-white p-4 rounded shadow">
            <div class="flex items-center gap-4">
                ...
                <div class="flex gap-2">
                    <button type="button" onclick="window.location.href='{{ route('admin.ticket-categories.index') }}'"
                    ...
                    @foreach ($categories as $cat)
                        <tr class="border-t">
                            ...
                            <td class="px-4 py-2 text-right">
                                <button type="button"
                                   onclick="window.location.href='{{ route('admin.ticket-categories.edit', $cat) }}'"
