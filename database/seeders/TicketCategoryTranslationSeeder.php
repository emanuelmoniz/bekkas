    ...
    public function run(): void
    {
        ...
        DB::table('ticket_category_translations')->insert([
            ...
            [
                ...
                'name'               => 'R&D',
                'description'        =>
                    "Full product development from scratch. You have an idea — we model, prepare and print it.\n\n" .
            ...
            [
                ...
                'description'        =>
                    "Desenvolvimento completo do produto a partir de uma ideia. Você tem a ideia — nós modelamos, preparamos e imprimimos.\n\n" .
            ...
            [
                ...
                'name'               => 'Preparation',
                'description'        =>
                    "You already have a 3D model file, but it needs to be optimised for printing.\n\n" .
            ...
            [
                ...
                'name'               => 'Preparação',
                'description'        =>
                    "Já tem um ficheiro com um modelo 3D, mas este precisa de ser otimizado para impressão.\n\n" .
            ...
            [
                ...
                'name'               => 'Print',
                'description'        =>
                    "You have a fully print-ready file and just need it printed.\n\n" .
            ...
            [
                ...
                'name'               => 'Impressão',
                'description'        =>
                    "Já tem um ficheiro totalmente preparado para impressão e apenas pretende imprimir.\n\n" .
