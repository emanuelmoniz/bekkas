...
class StaticTranslationsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Ensure placeholders remain in the DB; replacements occur at runtime
